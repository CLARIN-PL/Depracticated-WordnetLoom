...
public abstract class AbstractFilterExtractorFromUrl {
	...
	protected pl.edu.pwr.wordnetloom.common.model.PaginationData extractPaginationData() {
		final int perPage = getPerPage();
		final int firstResult = getPage() * perPage;

		String orderField;
		pl.edu.pwr.wordnetloom.common.model.PaginationData.OrderMode orderMode;
