...
public interface Workbench {
	 ...
	 * 
	 * @param isVisible
	 *            - TRUE okno jest widoczne, FALSE nie jest schowane
	 */
	 ...
	 * 
	 * @param isVisible
	 *            - TRUE okno jest widoczny, FALSE nie
	 */
	 ...
	 * 
	 * @param view
	 *            - obiekt reprezentujący widok
	 * @param pos
	 *            - pozycja w widoku, znaczenia jest uzaleznione od
	 *            implementacji perspektywy
	 * @param perspectiveName
	 *            - nazwa perspektywy, w której widok ma zostać zainstalowany
	 */
