...
package pl.edu.pwr.wordnetloom.plugins.viwordnet.frames;
...
public class DeleteRelationFrame extends IconDialog implements ActionListener {
	 ...
	 * @param edges edges collection representing collection of relations 
	 * from which one or more should be removed
	 */
	 ...
	 * @param edges collection of edges being representation of relations 
	 * to delete
	 * */
...
//		for (ViwnEdgeSynset ves : edges) {
//			relations.addItem(ves);
//		}
...
//			}	
	...
	public static Collection<ViwnEdge> showDeleteSynsetDialog(JFrame baseFrame, Collection<ViwnEdgeSynset> edges) {
		DeleteRelationFrame drf = new DeleteRelationFrame(baseFrame,Labels.REMOVE_RELATION
				,WIDTH,HEIGHT,edges);
		drf.setVisible(true);
		return drf.removed;
	}
