...
public class SynsetCriteria extends CriteriaPanel implements ActionListener {
	...
	public void restoreCriteria(CriteriaDTO criteria) {
		...
		getLexiconComboBox().setSelectedItem(criteria.getLexicon());
		getPartsOfSpeachComboBox().setSelectedItem(criteria.getPartOfSpeech());
		getDomainComboBox().setSelectedItem(criteria.getDomain());
		getRelationsComboBox().setSelectedItem(criteria.getRelation());
