...
public abstract class AbstractViewUI implements KeyListener {
	...
	/**
	 * Utworzenie zawartosci panelu. Za pomocą tej metody dostawne są przyciski i
	 * inne elementy interfjesu użytkownika
	 * @param content
	 */
	...
	/**
	 * Ustawienie koloru tła dla panelu oraz elementów do niego
	 * należących takich jak inne panele i checkboxy
	...
	/**
	 * Instalacja globalnego skrotu klawiszowego, który działa w obrębie
	 * całej perspektywy - np. tak rozwiązywane sa przyciski na toolbarze 
	 * @param button - przycisk
	...
	/**
	 * Odczytanie glownego elementu okna, na którym ma zostać
	 * ustawiony focus w sytuacji gdy następuje przejście pomiędzy
	 * widokami za pomocą Ctrl+1, Ctrl+2
