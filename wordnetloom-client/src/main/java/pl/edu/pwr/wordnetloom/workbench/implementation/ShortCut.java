...
/**
 * Klasa przechowujaca skroty klawiszowe dla przyciskow i komponentów
 * oraz związane z nimi akcje
 * @author Max
 */
public class ShortCut {
	...
	/**
	 * Konstruktor dla skrótu, który jest instalowany dla przycisku
	 * i powoduje wywołanie kliknięcia w przycisk
