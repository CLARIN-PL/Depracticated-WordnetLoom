...
public class ViwnLexicalUnitRelationsViewUI extends AbstractViewUI
    ...
    protected void initialize(JPanel content) {
        ...
        addRelation = new ButtonExt(this);
        addRelation.setIcon(addIcon);
        ...
        delRelation = new ButtonExt(this);
        delRelation.setIcon(removeIcon);
