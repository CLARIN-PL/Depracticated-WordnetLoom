...
/**
 * Class works as manager of parent and kids for view UI that can be cloned to separate window.
 * @author Max
 *
 * @param <T>
 */
public class FamilyManager<T extends AbstractViewUI> {
	...
	/**
	 * Add new child to the family. It crate new window wrapper for view and shows it.
	 * @param workbench
	 * @param title
	 * @param childObject
	 * @param childManager
	...
	/**
	 * Windows activity listener. When the windows is closed, the child is unregistered from parent view.
	 */
