...
public class RemoteUtils {
	...
	public static ExtGraphExtensionServiceRemote extGraphExtensionRemote = RMIUtils
			.lookupForService(ExtGraphExtensionServiceRemote.class);
	public static ExtGraphServiceRemote extGraphRemote = RMIUtils.lookupForService(ExtGraphServiceRemote.class);
	public static LexicalRelationServiceRemote lexicalRelationRemote = RMIUtils
			.lookupForService(LexicalRelationServiceRemote.class);
	public static LexicalUnitServiceRemote lexicalUnitRemote = RMIUtils
			.lookupForService(LexicalUnitServiceRemote.class);
	public static RelationTypeServiceRemote relationTypeRemote = RMIUtils
			.lookupForService(RelationTypeServiceRemote.class);
	public static SynsetRelationServiceRemote synsetRelationRemote = RMIUtils
			.lookupForService(SynsetRelationServiceRemote.class);
	...
	public static UnitAndSynsetServiceRemote unitAndSynsetRemote = RMIUtils
			.lookupForService(UnitAndSynsetServiceRemote.class);
	public static WordFormServiceRemote wordFormsRemote = RMIUtils.lookupForService(WordFormServiceRemote.class);
	public static UnitsRelationsServiceRemote unitsRelationsRemote = RMIUtils
			.lookupForService(UnitsRelationsServiceRemote.class);
	public static DynamicAttributesServiceRemote dynamicAttributesRemote = RMIUtils
			.lookupForService(DynamicAttributesServiceRemote.class);
