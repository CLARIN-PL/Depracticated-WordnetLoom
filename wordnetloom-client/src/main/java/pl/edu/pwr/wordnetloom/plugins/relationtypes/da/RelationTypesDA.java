...
package pl.edu.pwr.wordnetloom.plugins.relationtypes.da;
...
import pl.edu.pwr.wordnetloom.plugins.viwordnet.ViWordNetPlugin;
...
public class RelationTypesDA {
	...
	public static List<RelationTest> getTests(RelationType rel) {
		return RemoteUtils.relationTypeRemote.dbGetTests(rel);
	}
	 ...
	 *            - relacja nadrzedna
	 * @param order
	 * @param moveTestsAndConnections
	 *            - czy przeniesc testy i powiazania
	 */
	 ...
	 * 
	 * @param rel
	 *            - relacja dla ktorej ma zostac odczytana odwrotna
	...
	static public HashMap<String, RelationType> getRelationSymbols() {
		// FIXME: hidden!
		return null;
		// HashMap<String, RelationType> mapping = new HashMap<String,
		// RelationType>();
		// Collection<RelationType> relations =
		// RemoteUtils.relationTypeRemote.dbFullGetRelationTypes();
