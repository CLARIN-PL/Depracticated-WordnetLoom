...
package pl.edu.pwr.wordnetloom.systems.models;
 ...
 * @author Max
 * @param <T>
 *            - klasa bedaca skladnikiem kolekcji
 */
...
//				}
		...
		Comparator<Sense> senseComparator = new Comparator<Sense>() {
			...
			public int compare(Sense a, Sense b) {
				...
				if(c==0){
					if(a.getSenseNumber() == b.getSenseNumber()) c=0;
					if(a.getSenseNumber() > b.getSenseNumber())  c=1;
					if(a.getSenseNumber() < b.getSenseNumber())  c=-1;
				}
				if(c==0){
