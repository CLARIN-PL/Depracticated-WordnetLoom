 ...
 *
 */
public class ViwnGraphViewModalGraphMouse extends AbstractModalGraphMouse implements ModalGraphMouse, ItemSelectable {
	...
	protected void loadPlugins() {
		...
		// pickingPlugin = new
		// PickingGraphMousePlugin<ViwnNode,ViwnEdge>(InputEvent.BUTTON1_MASK,
		// InputEvent.BUTTON1_MASK | InputEvent.CTRL_MASK);
		pickingPlugin = new ViwnPickingGraphMousePlugin();
		// animatedPickingPlugin = new
		// AnimatedPickingGraphMousePlugin<ViwnNode,ViwnEdge>(InputEvent.BUTTON1_MASK
