...
package pl.edu.pwr.wordnetloom.plugins.viwordnet.visualization.decorators;
...
/**
 * <p><b>ViwnVertexToolTipTransformer</b></p>
 * <p>this class provides tooltips for vertices at visualization viewer<br>
...
public class ViwnVertexToolTipTransformer implements Transformer<ViwnNode, String> {
    public String transform(ViwnNode vn) {
        ...
        if (vn instanceof ViwnNodeCandExtension) {
            ...
            ret = vns.getUnitsStr();
        } else if (vn instanceof ViwnNodeSynsetSet) {
            int cand = 0;
            int syns = 0;

            for (ViwnNode v : ((ViwnNodeSynsetSet) vn).getSynsets()) {
