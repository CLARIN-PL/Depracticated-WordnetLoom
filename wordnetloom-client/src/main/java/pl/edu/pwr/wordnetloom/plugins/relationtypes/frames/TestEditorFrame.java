...
public class TestEditorFrame extends IconDialog implements ActionListener {
	...
	private TestEditorFrame(JFrame owner,PartOfSpeech pos, String text) {
		...
		testPos=new ComboBoxPlain(PosManager.getInstance().getAllPOSes().toArray(new PartOfSpeech[]{}), null);
	 ...
	 * @param pos - czesc mowy
	 * @return tablica zawierajaca [nowy tekst,nowy pos] - jesli nowy tekst jest null to wcisnieto anuluj
	 */
