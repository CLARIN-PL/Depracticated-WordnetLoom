...
public class RelationTypes {
	...
	static private HashMap<Long, RelationTypes> all_rels =
			new HashMap<Long, RelationTypes>();

	static private HashMap<Long, List<RelationTypes>> top_child = 
			new HashMap<Long, List<RelationTypes>>();
	...
	static public void loadRels() {
		...
		List<RelationTypes> highest = new ArrayList<RelationTypes>();
		...
		for(RelationType r : full){
			...
			if(children == null){
				children = new ArrayList<RelationTypes>();
