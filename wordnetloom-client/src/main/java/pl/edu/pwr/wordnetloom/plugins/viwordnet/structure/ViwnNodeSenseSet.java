...
public class ViwnNodeSenseSet extends ViwnNode {
    ...
    private HashSet<ViwnNodeSense> senses = new HashSet<>();

    public void add(ViwnNodeSense sense) {
        senses.add(sense);
    }

    public boolean remove(ViwnNodeSense sense) {
        return senses.remove(sense);
    }
    ...
    public Collection<ViwnNodeSense> getSenses() {
    ...
    public String getLabel() {
        return "Lexical unit collection";
    }
    ...
    public String toString() {
        return "zbiór: [[ " + senses.toString() + "]]";
    }

    public boolean contains(ViwnNodeSense node) {
        return senses.contains(node);
    }
}
