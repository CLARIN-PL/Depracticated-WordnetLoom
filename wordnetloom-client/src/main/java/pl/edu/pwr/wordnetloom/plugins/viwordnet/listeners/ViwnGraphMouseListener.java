...
package pl.edu.pwr.wordnetloom.plugins.viwordnet.listeners;
...
/**
 * class ViwnGraphMouseListener 
 * implements GraphMouseListener and handles mouse actions in graph panel
 * @author amusial
 * */
