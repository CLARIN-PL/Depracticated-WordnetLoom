...
public class RemoteConnectionProvider implements Loggable {
    ...
    private Properties getEjbProperties() {
        ...
        ejbProperties.put("remote.connection.default.username", userSession.getUsername());
        ejbProperties.put("remote.connection.default.password", userSession.getPassword());
    ...
    public void setUserSession(UserSession data) {
        userSession = data;
    }
    ...
    public User getUser() {
        try {
            if (userSession != null && userSession.getUser() == null) {
                User u = lookupForService(UserServiceRemote.class).findUserByEmail(userSession.getUsername());
                userSession = new UserSession(userSession, u);
