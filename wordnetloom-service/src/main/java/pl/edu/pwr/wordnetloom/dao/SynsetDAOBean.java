...
public class SynsetDAOBean extends DAOBean implements SynsetDAOLocal {
    ...
    public void dbClone(Synset synset, List<Long> lexicons) {
        ...
        newSynset.setSplit(synset.getSplit());
...
//			e.printStackTrace();
    ...
    public List<Synset> dbGetUnits(List<Synset> synsets) {
        if (synsets.isEmpty()) return synsets;
    ...
    @Override
    public PaginatedData<Synset> findByFilter(SynsetFilter synsetFilter) {
        return null;
    }
    ...
    public String getSynsetAtrribute(Synset synset, String nazwaPola) {
        ...
        if (null == synsetAttribute
                ...
                || null == synsetAttribute.getValue().getText()) return "";
