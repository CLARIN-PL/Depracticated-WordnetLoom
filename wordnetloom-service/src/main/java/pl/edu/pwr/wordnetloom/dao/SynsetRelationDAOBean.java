...
@Stateless
// FIXME: poprawić nazwy
public class SynsetRelationDAOBean implements SynsetRelationDAOLocal {

    @EJB
    private RelationTypeDAOLocal relationType;
    ...
    public void dbDelete(SynsetRelation rel) {
        ...
        try {
            ...
            System.err.println(getClass() + ": WARRNING: " + e.getLocalizedMessage());
        }
    }
    ...
    public void dbDelete(RelationType relation) {
        local.getEM().createNamedQuery("SynsetRelation.dbDeleteByRelation")
                .setParameter("relation", relation.getId())
                .executeUpdate();
    }
