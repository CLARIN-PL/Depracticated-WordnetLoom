...
INSERT INTO application_labels (`label_key`, `value`, `language`) VALUES ('label.kpwr', 'Przykład KPWr', 'pl'),
  ...
  ('label.yes', 'Tak', 'pl'),
  ('label.no', 'Nie', 'pl'),
  ('label.borderColor.colon', 'Kolor:', 'pl'),
  ...
  ('hint.choose.borderColor.relation ', ' Wybór koloru relacji', 'pl'),
  ...
  ('label.borderColor.colon', 'Color:', 'en'),
  ...
  ('hint.choose.borderColor.relation', 'Choose relation borderColor', 'en'),
